...
kibana_post "/api/saved_objects/visualization/zeek-conn-count?overwrite=true" '{"attributes":{"title":"Zeek Conn Events","visState":"{\"title\":\"Zeek Conn Events\",\"type\":\"metric\",\"params\":{\"fontSize\":42},\"aggs\":[{\"id\":\"1\",\"enabled\":true,\"type\":\"count\",\"schema\":\"metric\",\"params\":{}}]}","uiStateJSON":"{}","kibanaSavedObjectMeta":{"searchSourceJSON":"{\"query\":{\"query\":\"zeek.log_type: conn\",\"language\":\"kuery\"},\"filter\":[],\"indexRefName\":\"kibanaSavedObjectMeta.searchSourceJSON.index\"}"}},"references":[{"name":"kibanaSavedObjectMeta.searchSourceJSON.index","type":"index-pattern","id":"zeek-filebeat-data-view"}]}'
kibana_post "/api/saved_objects/visualization/zeek-http-count?overwrite=true" '{"attributes":{"title":"Zeek HTTP Events","visState":"{\"title\":\"Zeek HTTP Events\",\"type\":\"metric\",\"params\":{\"fontSize\":42},\"aggs\":[{\"id\":\"1\",\"enabled\":true,\"type\":\"count\",\"schema\":\"metric\",\"params\":{}}]}","uiStateJSON":"{}","kibanaSavedObjectMeta":{"searchSourceJSON":"{\"query\":{\"query\":\"zeek.log_type: http\",\"language\":\"kuery\"},\"filter\":[],\"indexRefName\":\"kibanaSavedObjectMeta.searchSourceJSON.index\"}"}},"references":[{"name":"kibanaSavedObjectMeta.searchSourceJSON.index","type":"index-pattern","id":"zeek-filebeat-data-view"}]}'
kibana_post "/api/saved_objects/visualization/zeek-dns-count?overwrite=true" '{"attributes":{"title":"Zeek DNS Events","visState":"{\"title\":\"Zeek DNS Events\",\"type\":\"metric\",\"params\":{\"fontSize\":42},\"aggs\":[{\"id\":\"1\",\"enabled\":true,\"type\":\"count\",\"schema\":\"metric\",\"params\":{}}]}","uiStateJSON":"{}","kibanaSavedObjectMeta":{"searchSourceJSON":"{\"query\":{\"query\":\"zeek.log_type: dns\",\"language\":\"kuery\"},\"filter\":[],\"indexRefName\":\"kibanaSavedObjectMeta.searchSourceJSON.index\"}"}},"references":[{"name":"kibanaSavedObjectMeta.searchSourceJSON.index","type":"index-pattern","id":"zeek-filebeat-data-view"}]}'
kibana_post "/api/saved_objects/visualization/zeek-notice-count?overwrite=true" '{"attributes":{"title":"Zeek Notice Events","visState":"{\"title\":\"Zeek Notice Events\",\"type\":\"metric\",\"params\":{\"fontSize\":42},\"aggs\":[{\"id\":\"1\",\"enabled\":true,\"type\":\"count\",\"schema\":\"metric\",\"params\":{}}]}","uiStateJSON":"{}","kibanaSavedObjectMeta":{"searchSourceJSON":"{\"query\":{\"query\":\"zeek.log_type: notice\",\"language\":\"kuery\"},\"filter\":[],\"indexRefName\":\"kibanaSavedObjectMeta.searchSourceJSON.index\"}"}},"references":[{"name":"kibanaSavedObjectMeta.searchSourceJSON.index","type":"index-pattern","id":"zeek-filebeat-data-view"}]}'
...
kibana_post "/api/saved_objects/visualization/zeek-local-events-count?overwrite=true" '{"attributes":{"title":"Local Detection Events","visState":"{\"title\":\"Local Detection Events\",\"type\":\"metric\",\"params\":{\"fontSize\":42},\"aggs\":[{\"id\":\"1\",\"enabled\":true,\"type\":\"count\",\"schema\":\"metric\",\"params\":{}}]}","uiStateJSON":"{}","kibanaSavedObjectMeta":{"searchSourceJSON":"{\"query\":{\"query\":\"zeek.log_type: local_events\",\"language\":\"kuery\"},\"filter\":[],\"indexRefName\":\"kibanaSavedObjectMeta.searchSourceJSON.index\"}"}},"references":[{"name":"kibanaSavedObjectMeta.searchSourceJSON.index","type":"index-pattern","id":"zeek-filebeat-data-view"}]}'

echo "Creating dashboard..."
kibana_post "/api/saved_objects/dashboard/zeek-overview-dashboard?overwrite=true" '{"attributes":{"title":"Zeek Overview","description":"Expanded dashboard with protocol, geo, and local detections","hits":0,"optionsJSON":"{\"useMargins\":true,\"syncColors\":false,\"hidePanelTitles\":false}","panelsJSON":"[{\"version\":\"8.10.2\",\"type\":\"visualization\",\"panelIndex\":\"1\",\"gridData\":{\"x\":0,\"y\":0,\"w\":12,\"h\":8,\"i\":\"1\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_1\"},{\"version\":\"8.10.2\",\"type\":\"visualization\",\"panelIndex\":\"2\",\"gridData\":{\"x\":12,\"y\":0,\"w\":12,\"h\":8,\"i\":\"2\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_2\"},{\"version\":\"8.10.2\",\"type\":\"visualization\",\"panelIndex\":\"3\",\"gridData\":{\"x\":24,\"y\":0,\"w\":12,\"h\":8,\"i\":\"3\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_3\"},{\"version\":\"8.10.2\",\"type\":\"visualization\",\"panelIndex\":\"7\",\"gridData\":{\"x\":36,\"y\":0,\"w\":12,\"h\":8,\"i\":\"7\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_7\"},{\"version\":\"8.10.2\",\"type\":\"visualization\",\"panelIndex\":\"4\",\"gridData\":{\"x\":0,\"y\":8,\"w\":16,\"h\":12,\"i\":\"4\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_4\"},{\"version\":\"8.10.2\",\"type\":\"visualization\",\"panelIndex\":\"5\",\"gridData\":{\"x\":16,\"y\":8,\"w\":16,\"h\":12,\"i\":\"5\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_5\"},{\"version\":\"8.10.2\",\"type\":\"visualization\",\"panelIndex\":\"6\",\"gridData\":{\"x\":32,\"y\":8,\"w\":16,\"h\":12,\"i\":\"6\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_6\"},{\"version\":\"8.10.2\",\"type\":\"visualization\",\"panelIndex\":\"8\",\"gridData\":{\"x\":0,\"y\":20,\"w\":48,\"h\":8,\"i\":\"8\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_8\"}]","timeRestore":false,"kibanaSavedObjectMeta":{"searchSourceJSON":"{\"query\":{\"language\":\"kuery\",\"query\":\"\"},\"filter\":[]}"}},"references":[{"name":"panel_1","type":"visualization","id":"zeek-conn-count"},{"name":"panel_2","type":"visualization","id":"zeek-http-count"},{"name":"panel_3","type":"visualization","id":"zeek-dns-count"},{"name":"panel_4","type":"visualization","id":"zeek-conn-proto-mix"},{"name":"panel_5","type":"visualization","id":"zeek-http-status-distribution"},{"name":"panel_6","type":"visualization","id":"zeek-top-destination-countries"},{"name":"panel_7","type":"visualization","id":"zeek-notice-count"},{"name":"panel_8","type":"visualization","id":"zeek-local-events-count"}]}'
